...
import com.duongph.moneynote.domain.action.note.GetNoteInfoByTimeAction
...
class DashboardViewModel : BaseViewModel() {
    ...
    private val getNoteInfoByTimeAction = GetNoteInfoByTimeAction()
...
//        }
        getNoteInfoByTimeAction.invoke(GetNoteInfoByTimeAction.GetNoteInfoByTimeRV().apply {
